...
module.exports = function (app) {
  ...
  // FIXME Report abuse (doesn't work)
  ...
  // Preview
  app.get(['/:bin/:quiet(quiet)', '/:bin/:rev?/:quiet(quiet)'],
  ...
  app.get('/:bin/:rev?',spike.getStream,
    binHandler.getBinPreview
  );

  app.get('/:name/last?/:quiet(quiet)?', tag('keepLatest'), binHandler.testQuietAccess, binHandler.getLatestForUser, spike.getStream, binHandler.getBinPreview);
